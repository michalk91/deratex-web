...
function OtherServices() {
  ...
  return (
    <>
        ...
        <span className={classNames( "title", styles.underline)}>Nasze usługi obejmuja:</span>
          <ul ref={containerRef}  className={classNames(styles.textContainer, {["fade-in-up"]: animate})}>
            ...
            <li>
              Dezynfekcja, ozonowanie, dezodoracja pomieszczeń po zmarłych.
            </li>
    ...
    <Image
            ...
            // priority={true}
          />
          <a className="caption" href="https://www.freepik.com/free-vector/isometric-pest-control-service-house-disinfection-infographics-with-workers-insects-rodents-3d-vector-illustration_34481859.htm#query=pest%20control&position=1&from_view=search&track=sph">Image by macrovector on Freepik</a>
    </div>
        </div>
