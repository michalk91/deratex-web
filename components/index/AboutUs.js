...
return(
    <section
    className={classNames( styles.aboutUs, "innerContentWidth")}
    >
    ...
    <div>
      ...
      <p>
        ...
        świadczonych usług. Wdrażamy program ochrony przed szkodnikami
        zgodnie z systemami GHP, GMP i HACCP, IFS/BRC i AIB, które zapewnią
        Państwu bezpieczeństwo prowadzenia działalności w sektorze
        spożywczym i przetwarzającym żywność.
      </p>
    </div>
  </section>
)
